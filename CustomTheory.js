...
var init = () => {
    ...
    achievement15 = theory.createSecretAchievement(14, cat2, "Weierstra🅱️", "hi im xli🅱️ and i liek weierstra🅱️", "you C...", () => C.level > 1000);
    achievement16 = theory.createSecretAchievement(15, cat2, "Did you really think I wouldn't include another funny number achievment here?", "something else is funny", "69 levels of c1 and 420 levels of C2", () => tai.level === 420 && rao.level === 69);
